...
def test_builds_correct_url_and_params():
    ...
    with patch("check_permits.requests.get", return_value=resp) as mock_get:
        check_availability("2003", "2026", "07")

    args, kwargs = mock_get.call_args
    assert args[0] == f"{check_permits.BASE_URL}/2003/monthlyAvailabilitySummaryView"
    assert kwargs["params"] == {"year": "2026", "month": "07"}
